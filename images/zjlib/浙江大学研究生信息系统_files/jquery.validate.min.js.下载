...
$.extend($.validator, {
	...
	methods: {
		...
		_required: function(value, element, param) {
			// check if dependency is met
			if ( !this.depend(param, element) )
				return "dependency-mismatch";
			switch( element.nodeName.toLowerCase() ) {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/select
		select: function(value, element, param) {
			return this.optional(element) || (value != "-1" && value != null);
		},
		// http://docs.jquery.com/Plugins/Validation/Methods/select
		_select: function(value, element, param) {
			return this.optional(element) || (value != "-1" && value != null);
		},
	}
